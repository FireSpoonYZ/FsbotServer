...
public class CocService {
    ...
    @Autowired
    public CocService(CurrentCardMapper mapper, CardService cardService, DiceService diceService) {
        this.mapper = mapper;
    ...
    public Integer saveCard(
        ...
        card.setProperties(currentCard.getProperties());
    ...
    public Integer loadCard(
        ...
        Card card = cardService.load(ownerId, name);
        if (card == null) {
            return 0;
        }
    ...
    public CheckResult check(
        ...
        DiceResult diceResult = diceService.dice("1d100");
